...
<plugin>
  ...
  <configuration>
    ...
    <enableAllSecurityServices>false</enableAllSecurityServices> <5>
  </configuration>
  <dependencies> <6>
    <dependency>
...
IMPORTANT: if you use a custom property editor/converter, ensure to register it manually in `<reflection>` part of the plugin, see link:https://geronimo.apache.org/arthur/maven.html[Arthur Maven Plugin] documentation for details.
