...
public class DefaultOptionListsTest extends TestCase {
    ...
    public void testCharacter() throws Exception {
        commands.get("doCharacter").exec(null);
    }
    ...
    public void testString() throws Exception {
        commands.get("doString").exec(null);
    }

    public void testURI() throws Exception {
        commands.get("doURI").exec(null);
    }

    public static class Commands {

        @Command
        public void doByte(@Option("foo") @Default("2,3,5") final List<Byte> list) {
            assertNotNull(list);
        ...
        @Command
        public void doBoolean(@Option("foo") @Default("false,true,false") final List<Boolean> list) {
            assertNotNull(list);
        ...
        @Command
        public void doCharacter(@Option("foo") @Default("2,3,5") final List<Character> list) {
            assertNotNull(list);
        ...
        @Command
        public void doShort(@Option("foo") @Default("2,3,5") final List<Short> list) {
            assertNotNull(list);
        ...
        @Command
        public void doInt(@Option("foo") @Default("2,3,5") final List<Integer> list) {
            assertNotNull(list);
        ...
        @Command
        public void doLong(@Option("foo") @Default("2,3,5") final List<Long> list) {
            assertNotNull(list);
        ...
        @Command
        public void doFloat(@Option("foo") @Default("2,3,5") final List<Float> list) {
            assertNotNull(list);
        ...
        @Command
        public void doDouble(@Option("foo") @Default("2,3,5") final List<Double> list) {
            assertNotNull(list);
        ...
        @Command
        public void doString(@Option("foo") @Default("2,3,5") final List<String> list) {
            assertNotNull(list);
        ...
        @Command
        public void doURI(@Option("foo") @Default("2,3,5") final List<URI> list) {
            assertNotNull(list);
