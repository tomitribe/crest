...
public class OptionListsTest extends TestCase {
    ...
    public void testCharacter() throws Exception {
        commands.get("doCharacter").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testShort() throws Exception {
        commands.get("doShort").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testInt() throws Exception {
        commands.get("doInt").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testLong() throws Exception {
        commands.get("doLong").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testFloat() throws Exception {
        commands.get("doFloat").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testDouble() throws Exception {
        commands.get("doDouble").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testString() throws Exception {
        commands.get("doString").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public void testURI() throws Exception {
        commands.get("doURI").exec(null, "--foo=2", "--foo=3", "--foo=5");
    }

    public static class Commands {

        @Command
        public void doByte(@Option("foo") final List<Byte> list) {
            assertNotNull(list);
        ...
        @Command
        public void doBoolean(@Option("foo") final List<Boolean> list) {
            assertNotNull(list);
        ...
        @Command
        public void doCharacter(@Option("foo") final List<Character> list) {
            assertNotNull(list);
        ...
        @Command
        public void doShort(@Option("foo") final List<Short> list) {
            assertNotNull(list);
        ...
        @Command
        public void doInt(@Option("foo") final List<Integer> list) {
            assertNotNull(list);
        ...
        @Command
        public void doLong(@Option("foo") final List<Long> list) {
            assertNotNull(list);
        ...
        @Command
        public void doFloat(@Option("foo") final List<Float> list) {
            assertNotNull(list);
        ...
        @Command
        public void doDouble(@Option("foo") final List<Double> list) {
            assertNotNull(list);
        ...
        @Command
        public void doString(@Option("foo") final List<String> list) {
            assertNotNull(list);
