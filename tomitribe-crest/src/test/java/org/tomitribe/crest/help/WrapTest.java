...
public class WrapTest {
    ...
    public void testConstructor() {
        assertNotNull(new Wrap());
        final Constructor<?>[] cons = Wrap.class.getDeclaredConstructors();
        assertEquals(1, cons.length);
        assertTrue(Modifier.isPublic(cons[0].getModifiers()));
        assertTrue(Modifier.isPublic(Wrap.class.getModifiers()));
        assertFalse(Modifier.isFinal(Wrap.class.getModifiers()));
    }
