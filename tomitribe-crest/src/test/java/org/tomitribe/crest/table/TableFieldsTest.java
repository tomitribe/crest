...
public class TableFieldsTest {
    ...
    public void override() throws Exception {
        ...
        final Main main = new Main(Foo.class);
        assertTable(main.exec("override", "--table-fields=class.simpleName version id version releaseDate"),
                " class.simpleName   version   id   version   releaseDate \n" +
                        "------------------ --------- ---- --------- -------------\n" +
    ...
    public static class Foo {
        ...
        @Command
        @Table(fields = "id project.name version")
        ...
        @Command
        @Table
        public List<Branch> override(@Option("table-fields") final String fields) {
            return branches;
        }
    }
