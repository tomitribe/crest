...
public class TimeUtilsTest extends TestCase {
    ...
    public void testFormatMillis() throws Exception {

        {
            ...
            assertEquals("1 day, 22 hours, 33 minutes, 44 seconds and 555 milliseconds", formatMillis(time,
                    MILLISECONDS, DAYS));
            ...
            assertEquals("46 hours, 33 minutes, 44 seconds and 555 milliseconds", formatMillis(time, MILLISECONDS,
                    HOURS));
        ...
        { // Plural
            ...
            assertEquals("2 days, 2 hours, 2 minutes, 2 seconds and 2 milliseconds", formatMillis(time, MILLISECONDS,
                    DAYS));
        }
